...
#pragma endregion
	...
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 ptre.X = scrw/2-12*12+config1; //dividing for 2 - got strafeangle
	...
	private: System::Void timer2_Tick(System::Object^  sender, System::EventArgs^  e) {
				...
				// Sytem::Drawing::Point get;
				 ...
				 ptre.X = scrw/2+config1-config1+24; //dividing for 2 + got strafeangle and multiplied by 2
				 ptre.Y = get.Y; //get y position
...
private: System::Void timer3_Tick(System::Object^  sender, System::EventArgs^  e) {
					 get = System::Windows::Forms::Cursor::Position; 
					 ptre.X = scrw/4+sin(get.X)*24+sqrt(System::Convert::ToInt16(System::IO::File::ReadAllText("width.ini", System::Text::Encoding::Default)))+abs(Math::Floor(Math::Tan( get.X ))); //dividing for 2 + got strafeangle and multiplied by 4
					 ptre.Y = get.Y; //get y position
					 System::Windows::Forms::Cursor::Position::set(ptre); //make strafes
					 if( showstrafes ){
						 strafes++;
